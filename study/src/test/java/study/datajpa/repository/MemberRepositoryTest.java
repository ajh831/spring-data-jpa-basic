...
class MemberRepositoryTest {
    ...
    public void returnType() {
        ...
        System.out.println("findListByUsername = " + findListByUsername);

        Member findMemberByUsername = memberRepository.findMemberByUsername("AAA");
        System.out.println("findMemberByUsername = " + findMemberByUsername);

        Optional<Member> findOptionalByUsername = memberRepository.findOptionalByUsername("AAA");
        System.out.println("findOptionalByUsername = " + findOptionalByUsername.get());
    }
...
//    }
    ...
    public void pagingSlice() {
        ...
        // when
        Page<Member> page = memberRepository.findByAge(age, pageRequest); // api로 반환하면 안됨!!!
...
//        em.clear();
    ...
    public void queryHint() {
        ...
        findMember.setUsername("member2"); // 변경감지 X
